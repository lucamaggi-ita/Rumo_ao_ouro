# CAPÍTULO 20 — O mundo dos números

## Versão harmonizada do Capítulo 2

**Projeto:** Rumo ao Ouro  
**Função editorial:** harmonização do Capítulo 2  
**Formato:** digital-first, leitura em tela com caderno à parte  
**Status:** rascunho inicial concluído em 2026-06-19  
...
> **Especificação de figura — adaptar.** Converter a árvore textual em diagrama limpo, mantendo exatamente a ramificação `84 -> 2 e 42 -> 2 e 21 -> 3 e 7`; os fatores finais são `2`, `2`, `3` e `7`. A função é tornar visível a decomposição, sem acrescentar outro método de fatoração.
...
## 16. Problema em estilo OBMEP — As caixas de medalhas
...
## 17. Problema em estilo OBMEP — O número da porta
...
## 18. Problema em estilo OBMEP — O primo escondido
...
## 19. Oficina Olímpica 1 — Pensar os números por dentro
...
1. olhar o número por dentro, não apenas pelo tamanho;
2. procurar divisões sem sobra;
3. reconhecer divisores;
4. reconhecer múltiplos como trilhas;
5. ver divisor e múltiplo como dois lados da mesma relação;
6. listar divisores por pares para não esquecer casos;
7. usar contraexemplos para testar frases com “todo”, “sempre” e “nunca”;
8. reconhecer números primos;
9. reconhecer números compostos;
10. decompor números compostos em fatores primos;
11. separar informação essencial de informação decorativa;
12. deixar a ideia nascer antes do nome.

> **Ferramenta 11 — Procurar contraexemplos**

> **Ferramenta 14 — Identificar a informação essencial**
