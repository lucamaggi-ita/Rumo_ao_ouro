# CAPÍTULO 21 — Quando sobra, nasce uma ideia

**Versão harmonizada do Capítulo 3**  
**Função na montagem final:** substituir o Capítulo 3 antigo  
...
> **Especificação de figura — criar.** Junto à tabela desta seção, inserir uma faixa numerada com blocos de quatro e separadores de volta completa, mostrando a sequência de restos `0, 1, 2, 3` que se repete. A faixa sustenta a ideia de ciclo, sem estender os dados além dos já mostrados.
...
> **Especificação de figura — criar.** No ponto da decomposição de 37 horas, inserir um relógio de 12 horas com a partida às 3 horas, três voltas completas visualmente apagadas e somente o salto final de 1 hora até 4 horas destacado. A figura não deve ser deslocada para o fim do capítulo.
...
> **Especificação de figura — criar.** Junto ao exemplo semanal, inserir uma faixa ou roda de sete dias, sem datas reais, que mostre a volta completa e o deslocamento de três dias a partir de terça-feira. O resto deve permanecer como a informação que decide a chegada.
...
## 15. Problema em estilo OBMEP — O treino das lanternas
...
## 16. Problema em estilo OBMEP — A sequência das pulseiras
...
## 17. Problema em estilo OBMEP — O número da sala secreta
...
## 18. Problema em estilo OBMEP — A porta que não abre
...
## 19. Oficina Olímpica 2 — Restos e ciclos
